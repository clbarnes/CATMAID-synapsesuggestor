# -*- coding: utf-8 -*-
# Generated by Django 1.10.7 on 2017-06-01 21:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('convex_hull_2d', django.contrib.gis.db.models.fields.PolygonField(srid=0)),
        ...
        migrations.RunSQL(
            "SELECT setval('synapse_slice_id_seq',(SELECT GREATEST(MAX(id)+1,2) FROM synapse_slice));"
        ),
    ]
